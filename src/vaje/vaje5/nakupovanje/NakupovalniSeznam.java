package vaje.vaje5.nakupovanje;
        ...
        do {
            ...
            switch (ukaz) {
                ...
                case '1': // ustvari seznam
                    ...
                    dol = sc.nextInt();
                    if (vaje.vaje5.zbirke.Seznam.narediSeznam(dol))
                ...
                case '2': // dodaj element na konec
                    ...
                    element = sc.next();
                    if (vaje.vaje5.zbirke.Seznam.dodajNaKonecSeznama(element))
                ...
                case '3': // vrini element na mesto
                    ...
                    mesto = sc.nextInt();
                    if (vaje.vaje5.zbirke.Seznam.dodajVSeznam(element, mesto))
                ...
                case '4': // odstrani element na mestu
                    ...
                    mesto = sc.nextInt();
                    element = vaje.vaje5.zbirke.Seznam.odstraniIzSeznama(mesto);
                    if (element != null)
                ...
                case '5': // vrni dolžino seznama
                    dol = vaje.vaje5.zbirke.Seznam.dolzinaSeznama();
                    if (dol >= 0)
                ...
                case '6': // izpiši seznam
                    vaje.vaje5.zbirke.Seznam.izpisiSeznam();
                    break;
                /*case '7': // izpiši 64-bitno
                    VAJE.VAJE5.zbirke.Seznam.izpisiSeznam64Bit();
                    break;*/
                case '8': // uniči seznam
                    if (vaje.vaje5.zbirke.Seznam.uniciSeznam())
